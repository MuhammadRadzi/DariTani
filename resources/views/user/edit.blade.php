    ...
    <form method="POST" action="{{ route('user.update') }}" class="flex flex-col gap-5">
        ...
        <div>
            ...
            <input
                ...
                required
                class="w-full border border-[#878787] rounded-lg px-3 py-3 text-sm text-black focus:outline-none focus:ring-2 focus:ring-[#6EA12B] focus:border-transparent"
            >
        </div>
        ...
        <div>
            ...
            <textarea
                ...
                class="w-full border border-[#878787] rounded-lg px-3 py-3 text-sm text-black placeholder-[#969696] focus:outline-none focus:ring-2 focus:ring-[#6EA12B] focus:border-transparent resize-none"
            >{{ old('address', $customer->address) }}</textarea>
        </div>

        <button
            type="submit"
            class="bg-[#6EA12B] hover:bg-[#527820] transition-colors w-full h-[47px] rounded-lg text-white text-base font-medium mt-2"
        >
            Simpan Perubahan
        </button>
    </form>
